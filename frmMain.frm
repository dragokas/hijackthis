    ...
    For i = 0 To lstResults.ListCount - 1
        If lstResults.Selected(i) = True Then
            ...
            Select Case sPrefix ' RTrim$(Left$(lstResults.List(i), 3))
                ...
                Case "R3":             FixR3Item lstResults.List(i)
                Case "R4":             FixR4Item lstResults.List(i)
